...
#   + Generator-prior architecture (strided Conv2d, InstanceNorm, Sigmoid output)
#   + No Dataset/DataLoader — single forward pass on full image each iteration
#   + EMA early stopping — halts before overfitting to noise
#   + No noise model assumption; spectral bias acts as implicit regularizer
#
...
PNG_PATH    = "data/denoising_result_DIP.png"
