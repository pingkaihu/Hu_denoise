...
**適用腳本：** `denoise_N2V.py`、`denoise_log_N2V.py`、`denoise_N2V_multi.py`、`denoise_PN2V.py`、`denoise_PN2V_multi.py`、`denoise_apbsn.py`、`denoise_apbsn_multi.py`、`denoise_GR2R.py`、`denoise_DIP.py`
...
**N2V / PN2V / GR2R / Log-N2V：** 依序縮小以下參數：
